...
- [ ] 10.1 配置 Swagger/OpenAPI 注解
- [ ] 10.2 生成 OpenAPI 接口文档
- [ ] 10.3 编写 API 接口文档（包含请求/响应示例）
- [ ] 10.4 编写部署文档（数据库初始化、配置项说明）
- [ ] 10.5 编写运维手册（常见问题、故障排查）
- [ ] 10.6 准备测试环境配置
- [ ] 10.7 执行数据库迁移脚本
- [ ] 10.8 部署应用到测试环境
